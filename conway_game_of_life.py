...
menu = pygame_menu.Menu("Welcome", 350, 350, theme=pygame_menu.themes.THEME_BLUE)
...
menu.add.text_input('Name :', default='John Conway')
# menu.add_selector('Difficulty :', [('Hard', 1), ('Easy', 2)], onchange=set_difficulty)
# menu.add_text_input('Generations :', default=0, onchange=play_animation)
menu.add.button('Play', start_the_game)
menu.add.button('Rules', show_the_rules)
menu.add.button('Reset', reset_the_game)
